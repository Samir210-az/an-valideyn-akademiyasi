...
export function AdminSidebar() {
  ...
  return (
    <aside className="flex h-screen w-64 flex-col border-l-4 border-l-indigo-500 border-r border-slate-200 bg-white px-4 py-6">
      <div className="mb-8 rounded-xl bg-indigo-50 px-3 py-3">
